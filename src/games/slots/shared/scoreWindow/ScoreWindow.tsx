    ...
    <div className='relative font-sans text-[35px]'>
      ...
      >
        ...
        <defs>
          ...
          >
            <stop stopColor='#CD7C2E' />
            <stop offset='0.171875' stopColor='#D88A6A' />
            <stop offset='0.520841' stopColor='#FFFD9E' />
            <stop offset='0.838557' stopColor='#D88A6A' />
            <stop offset='1' stopColor='#CD7C2E' />
          </linearGradient>
        </defs>
      </svg>
